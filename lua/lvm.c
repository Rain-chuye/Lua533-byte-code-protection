...
void luaV_execute (lua_State *L) {
#ifdef USE_COMPUTED_GOTO
  static const void *const dispatch_table[64] = {
    ...
    &&L_OP_PAD1, &&L_OP_PAD2, &&L_OP_PAD3, &&L_OP_PAD4,
    &&L_OP_PAD5, &&L_OP_PAD6, &&L_OP_PAD7, &&L_OP_PAD8,
    &&L_OP_PAD9, &&L_OP_PAD10, &&L_OP_PAD11, &&L_OP_PAD12,
    &&L_OP_PAD13
  };
#endif
  CallInfo *ci = L->ci;
  ...
  for (;;) {
    ...
    vmentry
      ...
      vmcase(OP_PAD1) vmcase(OP_PAD2) vmcase(OP_PAD3) vmcase(OP_PAD4)
      vmcase(OP_PAD5) vmcase(OP_PAD6) vmcase(OP_PAD7) vmcase(OP_PAD8)
      vmcase(OP_PAD9) vmcase(OP_PAD10) vmcase(OP_PAD11) vmcase(OP_PAD12)
      vmcase(OP_PAD13) {
        lua_assert(0);
        vmbreak;
      }
