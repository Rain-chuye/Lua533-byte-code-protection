...
#define GET_OPCODE(i)	(cast(OpCode, (luaP_op_decode[cast(lu_byte, (DECRYPT_INST(i)>>POS_OP) & MASK1(SIZE_OP,0))])))
#define SET_OPCODE(i,o)	((i) = ENCRYPT_INST((((DECRYPT_INST(i))&MASK0(SIZE_OP,POS_OP)) | \
		((cast(Instruction, luaP_op_encode[(o)])<<POS_OP)&MASK1(SIZE_OP,POS_OP)))))
...
#define CREATE_ABC(o,a,b,c)	ENCRYPT_INST(((cast(Instruction, luaP_op_encode[(o)])<<POS_OP) \
			| (cast(Instruction, a)<<POS_A) \
			| (cast(Instruction, b)<<POS_B) \
			| (cast(Instruction, c)<<POS_C)))

#define CREATE_ABx(o,a,bc)	ENCRYPT_INST(((cast(Instruction, luaP_op_encode[(o)])<<POS_OP) \
			| (cast(Instruction, a)<<POS_A) \
			| (cast(Instruction, bc)<<POS_Bx)))

#define CREATE_Ax(o,a)		ENCRYPT_INST(((cast(Instruction, luaP_op_encode[(o)])<<POS_OP) \
