...
LOCAL_CFLAGS += -std=c99 -O3  -DNDEBUG -ffast-math -fomit-frame-pointer -fexcess-precision=fast -funroll-loops -DLUA_USE_JUMP_TABLE -DLUA_DL_DLOPEN -DLUA_COMPAT_5_2
