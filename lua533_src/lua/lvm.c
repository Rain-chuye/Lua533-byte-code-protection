...
#define vmdispatch(o)	goto *jumptable[o];
...
void luaV_execute (lua_State *L) {
    ...
    static const void *const jumptable[] = {
      ...
      &&L_OP_SELF, &&L_OP_ADD, &&L_OP_SUB, &&L_OP_MUL, &&L_OP_MOD,
      &&L_OP_POW, &&L_OP_DIV, &&L_OP_IDIV, &&L_OP_BAND, &&L_OP_BOR,
      &&L_OP_BXOR, &&L_OP_SHL, &&L_OP_SHR, &&L_OP_UNM, &&L_OP_BNOT,
      &&L_OP_NOT, &&L_OP_LEN, &&L_OP_CONCAT, &&L_OP_JMP, &&L_OP_EQ,
      &&L_OP_LT, &&L_OP_LE, &&L_OP_TEST, &&L_OP_TESTSET, &&L_OP_TESTNIL,
      &&L_OP_TESTNILSET, &&L_OP_SPACESHIP, &&L_OP_CALL, &&L_OP_TAILCALL,
      &&L_OP_RETURN, &&L_OP_FORLOOP, &&L_OP_FORPREP, &&L_OP_TFORCALL,
      &&L_OP_TFORLOOP, &&L_OP_SETLIST, &&L_OP_CLOSURE, &&L_OP_VARARG,
      &&L_OP_EXTRAARG, &&L_OP_TBC, &&L_OP_NEWARRAY, &&L_OP_TFOREACH
    };
#endif
  CallInfo *ci = L->ci;
  LClosure *cl;
